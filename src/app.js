...
import { ClientesModule } from './modules/clientes/clientesModule.js';
import { DizimoModule } from './modules/dizimo/dizimoModule.js';
...
class DoceJardimApp {
    constructor() {
        ...
        this.clientes = new ClientesModule(this);
        this.dizimo = new DizimoModule(this);
        ...
        if (modalEditarCliente) {
            modalEditarCliente.addEventListener('click', (e) => {
                if (e.target === modalEditarCliente) {
                    this.clientes.fecharModalEdicao();
                }
            });
        }

        // Fechar modal pagamento cliente
        const modalPagamentoCliente = document.getElementById('modalPagamentoCliente');
        if (modalPagamentoCliente) {
            modalPagamentoCliente.addEventListener('click', (e) => {
                if (e.target === modalPagamentoCliente) {
                    this.clientes.fecharModalPagamento();
                }
            });
        }
        ...
        if (screen) {
            ...
            switch(screenId) {
                ...
                case 'relatorioFinanceiroScreen':
                    ...
                    break;
                case 'clientesScreen':
                    await this.clientes.listar();
                    break;
                case 'dizimoScreen':
                    await this.dizimo.carregar();
                    this.dizimo.filtrar('mes');
                    break;
            }
        }
    }
